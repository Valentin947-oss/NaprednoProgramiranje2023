...
void one();
void two();
void three(); //Vnesuvanje na funkcii
void four();
void five();
void six();
...
int main()
{
	...
	short unsigned int compNum = 0;  //Mozini rezultati koi bi se dobile
